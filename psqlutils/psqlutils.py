...
def get_schemas(connection_config, include_default_schemas, log_level=DEFAULT_LOGGER_LEVEL):
    """
...
def get_tables(connection_config, schema_name, log_level=DEFAULT_LOGGER_LEVEL):
    """
...
def get_columns(connection_config, schema_name, table_name, log_level=DEFAULT_LOGGER_LEVEL):
    """
